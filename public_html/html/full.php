...
<div class="row" >
      ...
      <div class="col-sm-6" style="" >
        <img src="../images/27.gif" align="middle" class="responsive" style="width: 50%;   border-radius: 50px 50px 50px 50px;""  >
...
<div class="row" >
      ...
      <h1 align="center" style="color: black; font-size: 50; font-family: Times New Roman, Times, serif;"> <b> Sorry Seat Full !!!</b></h1>
      </div>
       <div class="col-sm-3">
          <p align="center"></p>
    </div>
...
<br>
 ...
 <div class="row" >
	...
	<div class="col-sm-4">
  	   	<input type="submit" name="submit" value="BACK TO BUS SELECTION" />
		</div>
  	   <div class="col-sm-4">
